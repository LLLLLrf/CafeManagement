<template>
    <div style="position:absolute;left:160px;">
            <div class="menu-name" style="margin-left: 30px; font-size: 1.3em;line-height: 20px;height: 20px;">{{page}}</div>
            <!-- 这里宽度设100vh才不会有左右滑动 -->
        ...
        <el-drawer
            ...
            <button @click="close" style="padding: 0 10px;" class="btn1">
            ...
            <div :id="titleId" style="width:86%;color: #fff;font-size:large;font-weight:bold;display:inline;margin:20px 7% 0 auto;">Product Details</div>
            </template>
...
<style scoped>
    ...
    .drinkcard:hover:active {
       transform: scale(0.98);
    }
    .drinkcard:hover::after {
        bottom: 0;
    }
    .drinkcard::after {
        content: "Add to Cart";
